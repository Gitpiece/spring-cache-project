...
import com.icfcc.cache.annotation.AnnotationConfigUtils;
...
//            AopAutoProxyConfigurer.
    ...
    private void registerCacheAspect(Element element, ParserContext parserContext) {
        if (!parserContext.getRegistry().containsBeanDefinition(AnnotationConfigUtils.CACHE_ASPECT_BEAN_NAME)) {
            ...
            BeanComponentDefinition beanComponentDefinition = new BeanComponentDefinition(def, AnnotationConfigUtils.CACHE_ASPECT_BEAN_NAME);
            ...
            beanComponentDefinition = new BeanComponentDefinition(def, AnnotationConfigUtils.CACHE_ASPECT_BEAN_NAME);
            BeanDefinitionReaderUtils.registerBeanDefinition(beanComponentDefinition, parserContext.getRegistry());
            parserContext.registerComponent(beanComponentDefinition);
        }
    }
...
//    private static class AopAutoProxyConfigurer {
    ...
    private static void parseCacheManagerProperty(Element element, BeanDefinition def) {
        def.getPropertyValues().addPropertyValue(new PropertyValue(CacheNamespaceHandler.DEFAULT_CACHE_MANAGER_BEAN_NAME,
