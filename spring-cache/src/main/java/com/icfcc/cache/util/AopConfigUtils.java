...
public abstract class AopConfigUtils {
    ...
    public static void forceAutoProxyCreatorToUseClassProxying(BeanDefinitionRegistry registry) {
        if (registry.containsBeanDefinition(AUTO_PROXY_CREATOR_BEAN_NAME)) {
            ...
            definition.getPropertyValues().addPropertyValue(new PropertyValue("proxyTargetClass", Boolean.TRUE));
        }
    }
    ...
    static void forceAutoProxyCreatorToExposeProxy(BeanDefinitionRegistry registry) {
        if (registry.containsBeanDefinition(AUTO_PROXY_CREATOR_BEAN_NAME)) {
            BeanDefinition definition = registry.getBeanDefinition(AUTO_PROXY_CREATOR_BEAN_NAME);
            definition.getPropertyValues().addPropertyValue(new PropertyValue("exposeProxy", Boolean.TRUE));
        }
    }
    ...
    private static BeanDefinition registerOrEscalateApcAsRequired(Class cls, BeanDefinitionRegistry registry, Object source) {
        ...
        beanDefinition.getPropertyValues().addPropertyValue(new PropertyValue("order", Ordered.HIGHEST_PRECEDENCE));
